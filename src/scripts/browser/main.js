...
function enableHighResResources () {
  ...
  session.defaultSession.webRequest.onBeforeSendHeaders((details, callback) => {
    ...
    if (cookie && details.method === 'GET' && details.url.startsWith('https://www.coinmarketcap.com/')) {
    ...
    callback({cancel: false, requestHeaders: details.requestHeaders}); // eslint-disable-line standard/no-callback-literal
  });
}
